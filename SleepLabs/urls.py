...
from SleepLabs.views import SleeplabsAPI,Devicestatus,Sleeplabsgraph, home, deviceData,sleep_labs_graph_api_v2, processSleepData, algov2, sleep_labs_graph_api_v3
